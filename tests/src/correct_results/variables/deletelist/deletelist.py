# deletelist (pyStage, converted from Scratch 3)
...
stage.set_monitor_position("data_listcontents", -235, 175)
stage.delete_list_variable("data_listcontents")
stage.set_monitor_position("data_listcontents", -235, 175)
...
def when_program_starts_1(self):
    self.add_list_variable("list", "thing")
    self.wait(1.0)
    self.delete_list_variable("list", 1)
